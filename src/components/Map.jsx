...
const Map = () => {
    const Markers = [
        ...
        { position: [12.555436798132744, 77.62490356095117], name: 'South India' },
      ];
    ...
    return (
      ...
      <MapContainer
        ...
        style={{ width: "100%", height: "calc(100vh - 30rem)", display: "flex", alignItems:"center", justifyContent:"center"}}
      >
        <TileLayer
